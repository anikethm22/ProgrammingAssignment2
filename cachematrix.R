...
## The create such a special matrix m you execute m <- makeCacheMatrix(x)
## where x is an ordinary matrix. You can then get the value with m$get()
## and change the value with m$set(y) where y is an ordinary matrix.
